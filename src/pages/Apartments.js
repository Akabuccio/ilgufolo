export function Apartments() {
  return `
    <!-- ============================================ -->
    <!-- GUFOLO FAMILY - Split Screen Section -->
    <!-- ============================================ -->
    <section id="gufolo-family" class="split-screen split-family">
      ...
      <div class="split-content">
        <div class="split-content-inner">
          <span class="apt-label apt-label-family">Appartamento Familiare</span>
          <h2>Gufolo Family – Appartamento nel Centro Storico di Ferrara</h2>
          <p class="apt-tagline">Per famiglie, gruppi e chi ama lo spazio.</p>
          
          <p class="apt-description">
            Un trilocale luminoso che ti accoglie con il calore di una vera casa. 
            La cucina abitabile è il cuore dell'appartamento, perfetta per chi ama cucinare anche in vacanza.
            Travi a vista e arredi curati creano un'atmosfera unica.
          </p>
          
          <!-- Internal Link to Experiences -->
          <p class="apt-link-experiences">
            <a href="/esperienze-ferrara/" data-link>Scopri cosa fare a Ferrara durante il tuo soggiorno →</a>
          </p>
    ...
    <!-- ============================================ -->
    <!-- GUFOLO SUITE - Split Screen Section (Reversed) -->
    <!-- ============================================ -->
